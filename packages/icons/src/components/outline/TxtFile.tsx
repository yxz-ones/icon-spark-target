...
const SvgTxtFile = memo(function ({
  className,
  color = 'currentColor',
  fontSize,
  highlight,
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M21 3v6a2 2 0 0 0 2 2h6" stroke="#FA9600" strokeLinejoin="round" />
      <rect
        x={3}
        y={12}
        width={14}
      ...
      />
      <path d="M6 16h8M6 20h5" stroke="#FA9600" strokeLinejoin="round" />
    </svg>
  )
})
SvgTxtFile.displayName = 'TxtFile'
